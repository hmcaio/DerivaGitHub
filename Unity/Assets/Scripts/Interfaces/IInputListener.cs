...
/// <summary>
/// Iterface for any class interested in touch input events
/// </summary>
public interface IInputListener
{
    void TapAction(Touch touch);

    void DoubleTapAction(Touch touch);

    void HoldAction(Touch touch);

    void SwipeAction(Touch touch, Swipe direction);
}
